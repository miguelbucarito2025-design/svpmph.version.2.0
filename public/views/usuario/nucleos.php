<article>
    <div class="container-title">
        ...
        <h1 class="title-pag">Nucleos</h1>
        <p class="text-pag">
            Creacion y control de los Nucleos para su respectiva asignación de ofertas academicas
        </p>
    </div>
    ...
    <section class="sec-table">
        ...
        <div class="container-table">
            <table class="">
                <thead>
                    <tr>
                        <th colspan="4"> Nucleos Registrados</th>
                    </tr>
                    <tr>
                        <th colspan="4">
                    ...
                    <tr>
                        ...
                        <th>Imagen de la sede</th>
                        <th>Imagen de la Logo</th>
                    </tr>
                </thead>

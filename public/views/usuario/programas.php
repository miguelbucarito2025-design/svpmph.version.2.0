<article>
    <div class="container-title">
        ...
        <h1 class="title-pag">Programas</h1>
        <p class="text-pag">
            Creacion y control de programas de Academicos , obtencion de metricas clave y monitoreo en tiempo real
        </p>
    </div>
    ...
    <section class="sec-table">
        ...
        <div class="container-table">
            <table class="">
                <thead>
                    <tr>
                        <th colspan="4"> Programas Registrados</th>
                    </tr>
                    <tr>
                        <th colspan="4">
                            <div class="items-table">
                                ...
                                <div class="filtros-table continer-item-table">
                                    Tipo de Programa
                                    <select name="tipo" id="tipo-programa">
                                        <?php

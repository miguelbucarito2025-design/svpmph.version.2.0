...
class CarrerasController extends Controller
{
    ...
    public function guardar(): void
    {
        ...
        $resImg = $this->subirArchivoR2($imgFiltrado, 'carrera', 'img');
        if (!$resImg['exito']) {
        ...
        try {
            ...
            $this->eliminarArchivosR2([$resImg['key']]);
            throw new AppException('Error Interno del servidor Al guardar la Mencion: ' . $e->getMessage(), 500);
        }
    ...
    public function actualizar(): void
    {
        ...
        if (!$imgActual) {
            $this->respuesta->json(null, 404, 'la Mencion no existe.');
            return;
        }
        ...
        if (!empty($_FILES['img']['name'])) {
            ...
            $resImg = $this->subirArchivoR2($imgFiltrada, 'carrera', 'img');
    ...
    public function buscar(): void
    {
        ...
        $this->respuesta->json($roles, 200, "Menciones obtenidos con éxito", [], (int)$total);
    }
